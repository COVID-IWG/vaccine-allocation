...
state_districts = {
    ...
    'Andhra Pradesh': ['Anantapur', 'Chittoor', 'East Godavari', 'Guntur', 'Krishna', 'Kurnool', 'Prakasam', 'S.P.S. Nellore', 'Srikakulam', 'Visakhapatnam', 'Vizianagaram', 'West Godavari', 'Y.S.R. Kadapa'],
    ...
    'Chhattisgarh': ['Balod', 'Baloda Bazar', 'Balrampur', 'Bametara', 'Bastar', 'Bijapur', 'Bilaspur', 'Dakshin Bastar Dantewada', 'Dhamtari', 'Durg', 'Gariaband', 'Gaurela Pendra Marwahi', 'Janjgir Champa', 'Jashpur', 'Kabeerdham', 'Kondagaon', 'Korba', 'Koriya', 'Mahasamund', 'Mungeli', 'Narayanpur', 'Raigarh', 'Raipur', 'Rajnandgaon', 'Sukma', 'Surajpur', 'Surguja', 'Uttar Bastar Kanker'],
    ...
    'Jammu And Kashmir': ['Anantnag', 'Bandipora', 'Baramulla', 'Budgam', 'Doda', 'Ganderbal', 'Jammu', 'Kathua', 'Kishtwar', 'Kulgam', 'Kupwara', 'Pulwama', 'Punch', 'Rajouri', 'Ramban', 'Reasi', 'Samba', 'Shopiyan', 'Srinagar', 'Udhampur'],
...
def tev_step(state, district):
    pass 

def figures(state = None, district = None):
    pass

state_districts = {k: v for (k, v) in state_districts.items() if k in ["Tamil Nadu", "Bihar"]}
...
with models.DAG("vaccine-allocation", schedule_interval = None, catchup = False) as dag:
    ...
    for (state, districts) in state_districts.items():
        ...
        for district in  districts:
            state_root >> epi_step(state, district) >> tev_step(state, district) >> [
                natl_figures,
                state_figures, 
